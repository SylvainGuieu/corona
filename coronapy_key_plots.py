...
if 5 in plt_list:
    ...
    subset = subset.get_day_indexed(origin).subset(start=0, end=45)
...
if 6 in plt_list:
    ...
    data = subset.get_day_indexed(origin).subset(start=0, end=45)
    ...
    axes.set(ylim=(1.5,23), xlabel="Days since 200 cases", ylabel="Doubling Time T in days", 
